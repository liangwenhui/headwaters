...
@Service
@Slf4j
public class HeadwatersImpl extends AbstractHeadwaters {
    ...
    @Override
    protected Result getIdFromBucketBuffer(final String key){
        Result res = null;
    ...
    @Override
    protected void updateBucket (final String key,Bucket bucket) throws Exception{
        StopWatch stopWatch = new Slf4JStopWatch();
        try {
